...
public class DbManager{
    ...
    private String[] COLUMNS = {DatabaseHelper.KEY_ID,DatabaseHelper.KEY_SSID,DatabaseHelper.KEY_BSSID,DatabaseHelper.KEY_CAPABILITIES,DatabaseHelper.KEY_LEVEL,DatabaseHelper.KEY_FREQUENCY,DatabaseHelper.KEY_HITS};
    ...
    private ContentValues createContentValues(String ssid, int rp, String bssid, String capabilities, int level, int frequency,int hits){
    ...
    public long addWifi(AccessPoint ap){
        ...
        ContentValues value=createContentValues(ap.getSSID(),ap.getRp(),ap.getBSSID(),ap.getCapabilities(),ap.getLevel(),ap.getFrequency(),ap.getHits());
